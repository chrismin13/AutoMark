package com.chrismin13.automark.utils;

// =================================================================== //
// CLASS TAKEN FROM:
// https://gist.github.com/kidinov/6900164
// Modified to enable and disable the top buttons as needed
// =================================================================== //
...
import com.chrismin13.automark.MainActivity;
...
public class UndoRedoHelper {
    ...
    public void undo() {
        ...
        MainActivity.getInstance().updateUndoRedoStatus();
    }
